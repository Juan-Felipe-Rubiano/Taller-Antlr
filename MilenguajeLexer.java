...
public class MilenguajeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T_BOOLEANO", "T_ENTERO", 
			"T_FLOTANTE", "T_CADENA", "RETORNAR", "BOOLEANO", "FLOTANTE", "ENTERO", 
			"CADENA", "SI", "SINO", "PARA", "MIENTRAS", "IDENTIFICADOR", "MAS", "MENOS", 
			"POTENCIADO", "MULTIPLICADO", "DIVIDIDO", "MODULO", "IGUAL", "DIFERENTE", 
			"MENORQUE", "MENORIGUAL", "MAYORQUE", "MAYORIGUAL", "LOGAND", "LOGOR", 
			"LOGNOT", "ASIGN", "BITAND", "BITOR", "BITNOT", "BITXOR", "BITLSHIFT", 
			"BITRSHIFT", "WS"
		};
	}
